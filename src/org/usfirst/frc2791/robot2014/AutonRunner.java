...
public class AutonRunner {
  ...
  public AutonRunner() {
    ...
    driveDistancePID = new BasicPID(Robot2014.getDoubleAutoPut("DriveDistance-PID_P", 1.0 / 8.0), 0.0,
      Robot2014.getDoubleAutoPut("DriveDistance-PID_D", 0.001));
  ...
  private boolean driveToDistance(double distance) {
    ...
    return (Math.abs(driveDistancePID.getError()) < 0.5) && (Math.abs(driveAnglePID.getError()) < 2.5) && (Math.abs(
      Robot2014.driveTrain.getSpeed()) < 0.1);
  }
